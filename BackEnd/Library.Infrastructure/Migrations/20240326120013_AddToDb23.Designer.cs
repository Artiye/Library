...
namespace Library.Infrastructure.Migrations
{
    ...
    [Migration("20240326120013_AddToDb23")]
    partial class AddToDb23
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserBookClub", b =>
                {
                    b.Property<int>("BookClubsBookClubId")
                        .HasColumnType("int");

                    b.Property<string>("MembersId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("BookClubsBookClubId", "MembersId");
            ...
            modelBuilder.Entity("Library.Domain.Entity.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0b59fcbd-3f75-43a5-9c8c-0efcbf8859bc",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEBcWelKYBb/upQdk9nRaS5bS7O+eGSFyj9oWehcxNbr/H5ZgBJq+1ufrf4mQJCQ8gg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "8995a7be-81cf-48f2-944d-ae10a63e1440",
            ...
            modelBuilder.Entity("ApplicationUserBookClub", b =>
                {
                    b.HasOne("Library.Domain.Entity.BookClub", null)
                        .WithMany()
                        .HasForeignKey("BookClubsBookClubId")
